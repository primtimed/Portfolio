...
export const projects: Project[] = [
    {
        ...
        "backgroundVideoUrl": "https://www.youtube.com/watch?v=fLexgOxsZu0&list=RDfLexgOxsZu0&start_radio=1",
        "url": "#",
        "sourceUrl": "#",
        "outcomes": [],
        "processSteps": [],
        ...
        "media": [
            {
                "type": "image",
                "src": "https://picsum.photos/seed/momentum-fps/800/1000",
                "caption": "Momentum FPS — cover art"
            },
            {
                "type": "video",
            ...
            {
                "type": "image",
                "src": "https://picsum.photos/seed/momentum-fps-wallrun/1200/800",
                "caption": "Wallrun chained into a dash"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/momentum-fps-netcode/1200/800",
                "caption": "Client-side prediction debug view"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/momentum-fps-grapple/1200/800",
                "caption": "Grapple + slide combo"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/momentum-fps-map/1200/800",
                "caption": "Map greybox pass"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/momentum-fps-hud/1200/800",
                "caption": "HUD and movement readout"
            }
        ]
    },
    {
        "title": "Card Tactics AI",
        "tagline": "Card strategy game with an AI that adapts mid-match.",
        "description": "A card-based strategy prototype where the opposing AI profiles the player's deck and playstyle as the match unfolds, adjusting its own strategy instead of following a fixed script.",
        "genre": "Strategy",
        "engine": "Unity",
        "status": "Prototype",
        ...
        "media": [
            {
                "type": "image",
                "src": "https://picsum.photos/seed/card-tactics-ai/800/1000",
                "caption": "Card Tactics AI — cover art"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/card-tactics-board/1200/800",
                "caption": "Match board mid-turn"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/card-tactics-ai-profile/1200/800",
                "caption": "AI playstyle profiling view"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/card-tactics-deck/1200/800",
                "caption": "Deck builder screen"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/card-tactics-effects/1200/800",
                "caption": "Modular card effect stack"
            }
        ]
    },
    {
        "title": "Streaming Hub UI",
        "tagline": "TV-first, remote-navigable streaming hub interface.",
        "description": "A web-based streaming hub UI designed to be fully navigable from a TV remote or gamepad — large focus states, predictable spatial navigation, and no reliance on a mouse or touch input.",
        "genre": "Interactive UI",
        "engine": "Web",
        "status": "In Development",
        ...
        "media": [
            {
                "type": "image",
                "src": "https://picsum.photos/seed/streaming-hub-ui/800/1000",
                "caption": "Streaming Hub UI — cover art"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/streaming-hub-rows/1200/800",
                "caption": "Row-based content browsing"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/streaming-hub-focus/1200/800",
                "caption": "TV-safe focus states"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/streaming-hub-remote/1200/800",
                "caption": "Remote navigation overlay"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/streaming-hub-detail/1200/800",
                "caption": "Title detail panel"
            }
        ]
    },
    {
        "title": "Architecture Sandbox",
        "tagline": "Playable showcase of state machines and modular systems.",
        "description": "A tech-demo sandbox built to showcase clean, scalable Unity architecture — modular state machines, component-based systems, and patterns meant to be dropped into other projects.",
        "genre": "Tech Demo",
        "engine": "Unity",
        "status": "In Development",
        ...
        "media": [
            {
                "type": "image",
                "src": "https://picsum.photos/seed/architecture-sandbox/800/1000",
                "caption": "Architecture Sandbox — cover art"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/architecture-sandbox-fsm/1200/800",
                "caption": "State machine visualizer"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/architecture-sandbox-demo/1200/800",
                "caption": "Playable pattern demo scene"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/architecture-sandbox-components/1200/800",
                "caption": "Component composition view"
            },
            {
                "type": "image",
                "src": "https://picsum.photos/seed/architecture-sandbox-scenes/1200/800",
                "caption": "Scene selection menu"
            }
        ]
    }
];
...
export const experience: ExperienceItem[] = [
    ...
    },
    {
        ...
        "meta": "Personal Project",
        "description": "Developed an AI-assisted Windows tool system in C# with safe, auditable, undoable actions.",
        "tags": [
            "C#",
            "AI-Assisted Tooling",
            "Windows Tooling"
    ...
    },
    {
        ...
        "meta": "Personal Project",
        "description": "Designed a card-based strategy game with adaptive AI logic that profiles player behavior mid-match.",
        "tags": [
            "Unity",
            "C#",
            "AI",
    ...
    },
    {
        "title": "Streaming Hub UI",
        "meta": "Personal Project",
        "description": "Created a web-based, remote-navigable streaming hub UI system built for TV-first browsing.",
        "tags": [
            "Vue",
            "TypeScript",
            "TV UI"
    ...
    },
    {
        ...
        "meta": "Ongoing",
        "description": "Implemented scalable Unity architecture patterns — state machines, modular, component-based systems.",
        "tags": [
            "Unity",
            "C#",
            "Architecture"
